...
return [
    ...
    'order_item_model' => App\Models\OrderItem::class,
    'product_resource' => App\Http\Resources\ProductResource::class,
    'stripe_payment' => App\StripePaymentHandler::class,
    'paypal_payment' => App\PaypalPaymentHandler::class
];
